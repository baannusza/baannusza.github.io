<?php
 /**
  * Title: Single Post
  * Slug: sports-outlet/single-post
  * Inserter: no
  */
?>
<!-- wp:columns -->
...
<div class="wp-block-column" style="padding-left:var(--wp--preset--spacing--30);flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"sports-outlet","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->